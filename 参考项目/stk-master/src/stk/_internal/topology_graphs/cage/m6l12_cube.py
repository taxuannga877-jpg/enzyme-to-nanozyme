...
class M6L12Cube(Cage):
    ...
    *Multi-Building Block Cage Construction*, a
    ...
    _x = np.sqrt(2)
    _vertex_prototypes = (
        NonLinearVertex(0, np.array([_x, 0, 0])),
        NonLinearVertex(1, np.array([0, _x, 0])),
        NonLinearVertex(2, np.array([-_x, 0, 0])),
        NonLinearVertex(3, np.array([0, -_x, 0])),
        NonLinearVertex(4, np.array([0, 0, _x])),
        NonLinearVertex(5, np.array([0, 0, -_x])),
        LinearVertex(6, np.array([1, 1, 0]), False),
        LinearVertex(7, np.array([1, -1, 0]), False),
        LinearVertex(8, np.array([1, 0, 1]), False),
        LinearVertex(9, np.array([1, 0, -1]), False),
        LinearVertex(10, np.array([-1, 1, 0]), False),
        LinearVertex(11, np.array([-1, -1, 0]), False),
        LinearVertex(12, np.array([-1, 0, 1]), False),
        LinearVertex(13, np.array([-1, 0, -1]), False),
        LinearVertex(14, np.array([0, 1, 1]), False),
        LinearVertex(15, np.array([0, 1, -1]), False),
        LinearVertex(16, np.array([0, -1, 1]), False),
        LinearVertex(17, np.array([0, -1, -1]), False),
    )
