...
class M12L24(Cage):
    ...
    *Multi-Building Block Cage Construction*, a
    ...
    _vertex_prototypes = (
        ...
        NonLinearVertex(1, np.array([-1, 0, 0])),
        NonLinearVertex(2, np.array([0, 1, 0])),
        NonLinearVertex(3, np.array([0, -1, 0])),
        NonLinearVertex(4, np.array([0.5, 0.5, 0.707])),
        NonLinearVertex(5, np.array([0.5, -0.5, 0.707])),
        NonLinearVertex(6, np.array([-0.5, 0.5, 0.707])),
        NonLinearVertex(7, np.array([-0.5, -0.5, 0.707])),
        NonLinearVertex(8, np.array([0.5, 0.5, -0.707])),
        NonLinearVertex(9, np.array([0.5, -0.5, -0.707])),
        NonLinearVertex(10, np.array([-0.5, 0.5, -0.707])),
        NonLinearVertex(11, np.array([-0.5, -0.5, -0.707])),
        LinearVertex(12, np.array([0.9, 0.31, 0.31]), False),
        LinearVertex(13, np.array([0.9, 0.31, -0.31]), False),
        LinearVertex(14, np.array([0.9, -0.31, 0.31]), False),
        LinearVertex(15, np.array([0.9, -0.31, -0.31]), False),
        LinearVertex(16, np.array([-0.9, 0.31, 0.31]), False),
        LinearVertex(17, np.array([-0.9, 0.31, -0.31]), False),
        LinearVertex(18, np.array([-0.9, -0.31, 0.31]), False),
        LinearVertex(19, np.array([-0.9, -0.31, -0.31]), False),
        LinearVertex(20, np.array([0.31, 0.9, 0.31]), False),
        LinearVertex(21, np.array([0.31, 0.9, -0.31]), False),
        LinearVertex(22, np.array([-0.31, 0.9, 0.31]), False),
        LinearVertex(23, np.array([-0.31, 0.9, -0.31]), False),
        LinearVertex(24, np.array([0.31, -0.9, 0.31]), False),
        LinearVertex(25, np.array([0.31, -0.9, -0.31]), False),
        LinearVertex(26, np.array([-0.31, -0.9, 0.31]), False),
        LinearVertex(27, np.array([-0.31, -0.9, -0.31]), False),
        LinearVertex(28, np.array([0.58, 0, 0.82]), False),
        LinearVertex(29, np.array([-0.58, 0, 0.82]), False),
        LinearVertex(30, np.array([0, 0.58, 0.82]), False),
        LinearVertex(31, np.array([0, -0.58, 0.82]), False),
        LinearVertex(32, np.array([0.58, 0, -0.82]), False),
        LinearVertex(33, np.array([-0.58, 0, -0.82]), False),
        LinearVertex(34, np.array([0, 0.58, -0.82]), False),
        LinearVertex(35, np.array([0, -0.58, -0.82]), False),
    )
