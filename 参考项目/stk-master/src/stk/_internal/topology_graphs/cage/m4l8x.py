...
class M4L8x(Cage):
    ...
    *Multi-Building Block Cage Construction*, a
    ...
    _non_linears = (
        NonLinearVertex(0, np.array([2, 1, 0])),
        NonLinearVertex(1, np.array([2, -1, 0])),
        NonLinearVertex(2, np.array([-2, 1, 0])),
        NonLinearVertex(3, np.array([-2, -1, 0])),
    )
    ...
    _edge_prototypes = (
        ...
        Edge(1, _vertex_prototypes[0], _vertex_prototypes[6]),
        Edge(2, _vertex_prototypes[0], _vertex_prototypes[7]),
        ...
        Edge(8, _vertex_prototypes[2], _vertex_prototypes[4]),
        Edge(9, _vertex_prototypes[2], _vertex_prototypes[8]),
        Edge(10, _vertex_prototypes[2], _vertex_prototypes[9]),
        Edge(11, _vertex_prototypes[2], _vertex_prototypes[11]),
        Edge(12, _vertex_prototypes[3], _vertex_prototypes[5]),
